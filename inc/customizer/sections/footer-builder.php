...
function turbo_customizer_footer_builder( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'turbo_footer_widgets_link_hover',
		array(
			'default'           => '#ffffff',
			'sanitize_callback' => 'sanitize_hex_color',
		)
