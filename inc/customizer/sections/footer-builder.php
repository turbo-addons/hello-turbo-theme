 ...
 */
function helloturbo_customizer_footer_builder( $wp_customize ) {

	// =============================================
	// Section: Footer Widgets Area
	// =============================================
	$wp_customize->add_section(
		'helloturbo_footer_widgets',
		array(
	...
	$wp_customize->add_setting(
		'helloturbo_footer_widgets_enable',
		array(
			'default'           => true,
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section' => 'helloturbo_footer_widgets',
			'type'    => 'checkbox',
		)
	);

	$wp_customize->add_setting(
		'helloturbo_footer_columns',
		array(
			'default'           => '4',
	...
	$wp_customize->add_setting(
		'helloturbo_footer_widgets_text',
		array(
			'default'           => '#d1d5db',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_widgets_link',
		array(
			'default'           => '#93c5fd',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_widgets_link_hover',
		array(
			'default'           => '#ffffff',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_widgets_heading',
		array(
			'default'           => '#ffffff',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_widgets_padding',
		array(
			'default'           => 60,
	...
	$wp_customize->add_setting(
		'helloturbo_copyright_text_left',
		array(
	...
	$wp_customize->add_setting(
		'helloturbo_copyright_text_right',
		array(
	...
	$wp_customize->add_setting(
		'helloturbo_footer_bar_text_color',
		array(
			'default'           => '#9ca3af',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_bar_link_color',
		array(
			'default'           => '#93c5fd',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_bar_link_hover',
		array(
			'default'           => '#ffffff',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_bar_border_top',
		array(
			'default'           => 1,
			'sanitize_callback' => 'absint',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_bar_border_color',
		array(
			'default'           => '#374151',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	...
	$wp_customize->add_setting(
		'helloturbo_footer_social_enable',
		array(
			'default'           => false,
			'sanitize_callback' => 'helloturbo_sanitize_checkbox',
		)
...
add_action( 'customize_register', 'helloturbo_customizer_footer_builder' );
