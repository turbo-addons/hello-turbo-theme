...
function turbo_customizer_global_container( $wp_customize ) {
	...
	$wp_customize->add_section( 'turbo_global_container', array(
	...
	// Site layout.
	$wp_customize->add_setting( 'turbo_site_layout', array(
		'default' => 'full-width', 'sanitize_callback' => 'turbo_sanitize_select',
	) );
	$wp_customize->add_control( 'turbo_site_layout', array(
	...
	// Container width.
	$wp_customize->add_setting( 'turbo_container_width', array(
		'default' => 1200, 'sanitize_callback' => 'absint',
	) );
	$wp_customize->add_control( 'turbo_container_width', array(
	...
	$wp_customize->add_setting( 'turbo_default_content_layout', array(
		'default' => 'normal', 'sanitize_callback' => 'turbo_sanitize_select',
	) );
	$wp_customize->add_control( 'turbo_default_content_layout', array(
	...
	// Narrow width.
	$wp_customize->add_setting( 'turbo_narrow_width', array(
		'default' => 750, 'sanitize_callback' => 'absint',
	) );
	$wp_customize->add_control( 'turbo_narrow_width', array(
		'label'       => __( 'Narrow Content Width (px)', 'helloturbo' ),
		'section'     => 'turbo_global_container',
		'type'        => 'number',
		'input_attrs' => array( 'min' => 500, 'max' => 1200, 'step' => 10 ),
	) );

	// Content top/bottom padding.
	$wp_customize->add_setting( 'turbo_content_padding_top', array(
		'default' => 40, 'sanitize_callback' => 'absint',
	) );
	$wp_customize->add_control( 'turbo_content_padding_top', array(
	...
	$wp_customize->add_setting( 'turbo_content_padding_bottom', array(
		'default' => 40, 'sanitize_callback' => 'absint',
	) );
	$wp_customize->add_control( 'turbo_content_padding_bottom', array(
