 ...
 */
function helloturbo_system_font_stack() {
 ...
 */
function helloturbo_font_stacks_list() {
	return array(
 ...
 */
function helloturbo_get_font_stack( $key ) {
	$stacks = array(
		'system'    => helloturbo_system_font_stack(),
		'helvetica' => '"Helvetica Neue", Helvetica, Arial, sans-serif',
		'georgia'   => 'Georgia, "Times New Roman", Times, serif',
		'mono'      => '"Courier New", Courier, monospace',
	);

	return isset( $stacks[ $key ] ) ? $stacks[ $key ] : helloturbo_system_font_stack();
}
 ...
 */
function helloturbo_register_customizer_panels( $wp_customize ) {
...
add_action( 'customize_register', 'helloturbo_register_customizer_panels', 5 );
